...
class ESC50Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if waveform.shape[0] > 1: # [channels,samples ] = [ 2,440000] [1,440000]
...
def train():
    ...
    optimizer = optim.AdamW(model.parameters(),lr=lr,weight_decay=weight_decay)  # [1, 0, 0, 0, 0] -> [0.9, 0.025, 0.0250, 0.025,0.025]
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch {epoch+1}/{num_epochs}, Loss: {avg_epoch_loss:.4f}, Validation Loss: {avg_val_loss:.4f}, Validation Accuracy: {accuracy:.2f}%")
